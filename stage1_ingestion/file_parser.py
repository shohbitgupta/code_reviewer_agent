...
from core.models import FileMeta, ParsedFile, ParsedSymbol
from stage1_ingestion.parsers.base import BaseParser
from stage1_ingestion.parsers.dart_parser import DartParser
from stage1_ingestion.parsers.kotlin_parser import KotlinParser
...
try:
    from stage1_ingestion.parsers.kotlin_ts_parser import KotlinTsParser
    _kotlin_parser: Type[BaseParser] = KotlinTsParser
    if not KotlinTsParser._make_parser():
        from stage1_ingestion.parsers.kotlin_parser import KotlinParser as _kotlin_parser  # noqa: F811
except Exception:
    from stage1_ingestion.parsers.kotlin_parser import KotlinParser as _kotlin_parser  # noqa: F811

try:
    from stage1_ingestion.parsers.rust_ts_parser import RustTsParser
    _rust_parser: Type[BaseParser] = RustTsParser
    if not RustTsParser._make_parser():
        from stage1_ingestion.parsers.rust_parser import RustParser as _rust_parser  # noqa: F811
except Exception:
    from stage1_ingestion.parsers.rust_parser import RustParser as _rust_parser  # noqa: F811

try:
    from stage1_ingestion.parsers.swift_ts_parser import SwiftTsParser
    _swift_parser: Type[BaseParser] = SwiftTsParser
    if not SwiftTsParser._make_parser():
        _swift_parser = SwiftParser  # noqa: F811
except Exception:
    _swift_parser = SwiftParser  # noqa: F811

try:
    from stage1_ingestion.parsers.dart_ts_parser import DartTsParser
    _dart_parser: Type[BaseParser] = DartTsParser
    if not DartTsParser._make_parser():
        _dart_parser = DartParser  # noqa: F811
except Exception:
    _dart_parser = DartParser  # noqa: F811
