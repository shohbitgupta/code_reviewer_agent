...
Usage:
    from agents.standards_agent import run_standards
...
# ── Default paths — project root next to agents/ ─────────────────────────────
_PROJECT_ROOT            = Path(__file__).parent.parent
_DEFAULT_STANDARDS_DIR   = _PROJECT_ROOT / "standards"          # preferred: directory
_DEFAULT_STANDARDS_FILE  = _PROJECT_ROOT / "coding_standards.md"  # legacy fallback
